 ...
 */
@Entity
@Table(name = "sifrarnik_uza_naucna_oblast", schema = "zamger", catalog = "")
public class SifrarnikUzaNaucnaOblastEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        SifrarnikUzaNaucnaOblastEntity that = (SifrarnikUzaNaucnaOblastEntity) o;

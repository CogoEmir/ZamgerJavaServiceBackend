 ...
 */
@Entity
@Table(name = "zavrsni_bb_tema", schema = "zamger", catalog = "")
public class ZavrsniBbTemaEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        ZavrsniBbTemaEntity that = (ZavrsniBbTemaEntity) o;
        ...
        if (zavrsni != that.zavrsni) return false;
